...
// TODO: 여기에 코드를 쓰세요
console.log(stock15 === 0 ? "품절" : `재고${stock15}게`);
// ───── 문제 16 ───── [응용]
// 편의점 계산입니다.
//   총액 = 가격 × 개수
//   회원이면 10% 할인
...
// TODO: 여기에 코드를 쓰세요
const total16 = price16 * count16;
if (member16 === "true") {
  console.log(`합계:${Math.round(total16 * 0.9)}`);
} else {
  console.log(`${total16}`);
}
// ───── 문제 17 ───── [도전]
...
// 답: TypeError: Cannot read properties of null (reading 'length')
// null 값은 객체가 아니므로 .length와 같은 속성을 참조할 수 없어 자바스크립트 엔진에서 타입 에러(TypeError)를
//  발생시킵니다.
