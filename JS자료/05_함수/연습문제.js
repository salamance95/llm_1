...
// TODO: 여기에 코드를 쓰세요
function order(menu, n) {
  console.log(`${menu} ${n}개`);
}
order("라떼", 1);
order("라떼", 3);
...
const raw16 = getRawTotal(1200, 5);
const final16 = applyDiscount(raw16, true);
...
// 답: ReferenceError: secret is not defined 함수 내에서 선언해서 밖에서는 사용 불가
